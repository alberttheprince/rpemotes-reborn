Locales['ar'] = {
 -- Arabic
        ...
        ['ptfxinfo'] = "اضغط ~y~G~w~ لاستخدام المؤثر البصري",
        ...
        ['btn_switch'] = "حركة",
        ['btn_increment'] = "زيادة",
        ['dead'] = "لا يمكنك استخدام الحركات أثناء الموت!",
        ['swimming'] = "لا يمكنك استخدام الحركات أثناء السباحة",
        ['notvalidpet'] = "RUH ROH! Incorrect ped model detected 🐕!",
        ['animaldisabled'] = "عذراً! حركات الحيوانات معطلة في هذا السيرفر",
        ['adultemotedisabled'] = "Bonk! Adult emotes disabled 🔞",
        ['toggle_instructions'] = "تبديل التعليمات",
        ['exit_binoculars'] = "الخروج من المنظار",
        ['toggle_binoculars_vision'] = "تبديل أوضاع الرؤية",
        ['exit_news'] = "الخروج من كاميرا الأخبار",
        ['toggle_news_vision'] = "تبديل أوضاع الرؤية",
        ['edit_values_newscam'] = "تعديل نص الأخبار",
        ['not_in_a_vehicle'] = "لا يمكنك تشغيل هذه الحركة أثناء وجودك في مركبة",
        ['in_a_vehicle'] = "يمكنك فقط تشغيل هذه الحركة أثناء وجودك في مركبة 🚷",
        ['no_anim_crawling'] = "لا يمكنك تشغيل الحركات أثناء الزحف",
        ['no_anim_right_now'] = "لا يمكنك تشغيل حركة الآن",
        -- Key maps
        ['register_cancel_emote'] = "إلغاء الحركة الحالية",
        ['register_open_menu'] = "فتح قائمة الحركات",
        ['register_handsup'] = "رفع اليدين",
        ['register_crouch'] = "الانخفاض",
        ['register_crawl'] = "الزحف",
        ['register_pointing'] = "الإشارة بالإصبع",
        ['register_ragdoll'] = "تبديل وضع الدمية",
        -- Commands descriptions
        ['cancel_emote'] = "إلغاء الحركة الحالية",
        ['crouch'] = "الانخفاض",
        ['crawl'] = "الزحف",
        ['pointing'] = "الإشارة بالإصبع"
}
