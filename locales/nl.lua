Locales['nl'] = {
 -- Dutch 🇳🇱
        ...
        ['help_variation'] = '(Optioneel) 1, 2, 3 of een ander geldig nummer. Verandert de texture van een accessoire in een animatie, bijvoorbeeld de kleur van een telefoon. Voor een lijst van varianten -1',
