Locales['en'] = {
    ...
    ['setmood'] = "Set your current mood/expression.",
    ...
    ['idlecamoff'] = "Disables the idle cam",
    ['idlecamon'] = "Re-enables the idle cam",
    ['toggle_news_vision'] = "Toggle between vision modes",
    ['edit_values_newscam'] = "Edit the news text",
    ['use_newcams'] = "Use newscam",
