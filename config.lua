...
Config.Languages = {
    ...
    ['sv'] = { -- Swedish 🇸🇪
        ...
        ['suggestions'] = "Förslag?",
        ['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ på FiveM-forum för alla funktioner/emote-förslag! ✉️",
    ...
    ['fi'] = { -- Finnish 🇫🇮
        ...
        ['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ Fivem foormueilta mitä vain fiituria/emote ehdotusta! ✉️",
