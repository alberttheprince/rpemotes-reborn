...
DP.Shared = {
    ...
    ["csdog2"] = { "misssnowie@little_doggy_lying_down", "base", "Small Dog Carried", "csdog",
        AnimationOptions = { -- Emote by MissSnowie
            EmoteMoving = false,
            EmoteLoop = true,
            Attachto = true,
            xPos = -0.040,
    ...
    ["csdog3"] = { "hooman@hugging_little_doggy", "base", "Carry Small Dog 2", "csdog4",
        AnimationOptions = { -- Emote by MissSnowie
            EmoteMoving = true,
            EmoteLoop = true,
        } },
    ["csdog4"] = { "little_doggy@hugging_hooman", "base", "Small Dog Carried 2", "csdog3",
        AnimationOptions = { -- Emote by MissSnowie
            EmoteMoving = false,
            EmoteLoop = true,
            bone = 24818,
